package com.smartcloud.auth.spring.boot.autoconfigure.utils;

import com.smartcloud.auth.api.pojo.Constant;
...
public class AccessTokenUtils {
    ...
    public List<BaseRole> getRoleInfo(){
        ...
        long size = baseRoleTemplate.opsForList().size(userId.toString());
        return baseRoleTemplate.opsForList().range(userId.toString(), 0, size);
    }
