package com.smartcloud.auth.provider.config.auth;


import com.smartcloud.auth.provider.config.auth.filter.PhoneLoginAuthenticationFilter;
import com.smartcloud.auth.provider.config.auth.filter.QrLoginAuthenticationFilter;
import com.smartcloud.auth.provider.config.auth.handler.MyLoginAuthSuccessHandler;
import com.smartcloud.auth.provider.config.auth.provider.PhoneAuthenticationProvider;
import com.smartcloud.auth.provider.config.auth.provider.QrAuthenticationProvider;
import com.smartcloud.auth.provider.service.PhoneUserDetailService;
import com.smartcloud.auth.provider.service.QrUserDetailService;
