...
import ClassInfoAddForm from './ClassInfoAdd.vue'
import ClassInfoEditFrom from './ClassInfoEdit.vue'
import StudentList from './StudentList.vue'
export default {
  components: {
    'add-user': ClassInfoAddForm,
    'edit-user': ClassInfoEditFrom,
    'role-set': StudentList
  },
  created () {
    // 加载表格数据
    this.loadTable()
